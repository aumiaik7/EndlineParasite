package com.icddrb.app.cifhevsurveillanceadult;
...
public class EditEntry extends BaseActivity {
		...
		listentries.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v, int pos,
				...
				if (CommonStaticClass.subEdit.equalsIgnoreCase("Adults")) {
					...
					CommonStaticClass.dataid_store = dataid;
				}

				else if (CommonStaticClass.subEdit
						.equalsIgnoreCase("AdultsDischarge")) {
					CommonStaticClass.dataId = dataid;
					CommonStaticClass.dataid_store = dataid;

				} else if (CommonStaticClass.subEdit
						.equalsIgnoreCase("Neonates")) {
					CommonStaticClass.HouseholdCode = dataid.substring(0, 5);
					CommonStaticClass.dataId = dataid;
					CommonStaticClass.dataid_store = CommonStaticClass.HouseholdCode;

				} else if (CommonStaticClass.subEdit
						.equalsIgnoreCase("NeonatesDischarge")) {
					CommonStaticClass.HouseholdCode = dataid.substring(0, 5);
					CommonStaticClass.dataId = dataid;
					CommonStaticClass.dataid_store = CommonStaticClass.HouseholdCode;
				} else {
	...
	*/
		...
		String sql = "";
		if (CommonStaticClass.subEdit.equalsIgnoreCase("Adults")) {
			sql = "Select dataid from tblMainQues";
		}
		else if (CommonStaticClass.subEdit.equalsIgnoreCase("AdultsDischarge")) {
			sql = "select dataid from tblMainQues where QD1_4 != ''";
		}
		else if (CommonStaticClass.subEdit.equalsIgnoreCase("Neonates")) {
			sql = "select dataid from tblNeonate";
		}
		else if (CommonStaticClass.subEdit.equalsIgnoreCase("NeonatesDischarge")) {
			sql = "select DNeonateID as dataid from tblNeonate where DNeonateID != ''";
		}
		else if (CommonStaticClass.subEdit.equalsIgnoreCase("")) {
			sql = "Select dataid from tblMainQues";
		} else {
			sql = "Select dataid from tblMainQues";
		}
		...
		try {
			...
			if (mCursor.moveToFirst()) {
				do {
					CommonStaticClass.dataId = mCursor.getString((mCursor
