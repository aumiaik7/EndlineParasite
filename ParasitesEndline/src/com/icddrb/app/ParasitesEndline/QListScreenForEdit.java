package com.icddrb.app.ParasitesEndline;
...
import com.icddrb.app.ParasitesEndline.Search.SearchLayout;
import com.icddrb.app.ParasitesEndline.Viewall.Viewall;
import com.icddrb.app.ParasitesEndline.adapters.QlistAdapter;
...
public class QListScreenForEdit extends BaseActivity {
	...
	private void loadDataToList() {
		String sql = "";
		if (!CommonStaticClass.isMember)
			sql = "Select * from tblQuestion where SLNo<8";
