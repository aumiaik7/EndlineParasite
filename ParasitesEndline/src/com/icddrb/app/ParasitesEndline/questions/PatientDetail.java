package com.icddrb.app.ParasitesEndline.questions;
...
import com.icddrb.app.ParasitesEndline.BaseActivity;
import com.icddrb.app.ParasitesEndline.CommonStaticClass;
import com.icddrb.app.ParasitesEndline.R;
import com.icddrb.app.ParasitesEndline.db.DatabaseHelper;
...
public class PatientDetail extends BaseActivity {
	...
	public Boolean SavePatientDetail(
			com.icddrb.app.ParasitesEndline.db.DatabaseHelper dbHelper, ViewGroup v) {
	...
	private boolean IsValidDischargeDate(ViewGroup vg,
			com.icddrb.app.ParasitesEndline.db.DatabaseHelper dHelper) {
		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
	...
	public ArrayList<String> GetDistrict(
			com.icddrb.app.ParasitesEndline.db.DatabaseHelper helper) {
		ArrayList<String> list = new ArrayList<String>();
		/*
		 * String sql = String
	...
	public ArrayList<String> GetUpazilla(
			com.icddrb.app.ParasitesEndline.db.DatabaseHelper helper, String District) {
		ArrayList<String> list = new ArrayList<String>();
		list.add(" ");
		String sql = "";
	...
	public boolean IsValidMEMSCVB(com.icddrb.app.ParasitesEndline.db.DatabaseHelper helper,
